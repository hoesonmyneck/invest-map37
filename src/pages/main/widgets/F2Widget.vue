        ...
        <div v-else class="overflow-auto h-[calc(94vh)] grid">
          <div class="grid grid-cols-1">
            <div class="max-h-[40vh] overflow-scroll text-white">
              <div
                class="head grid grid-cols-[2fr_120px_120px_120px] mb-2 pb-2 border-b border-gray-600"
              >
                <p>Наименование</p>
                <p>Количество</p>
                <p>Прирост</p>
              ...
              <div
                class="mt-1 gap-1 grid grid-cols-[2fr_120px_120px_120px] text-[12px]"
                v-for="i in list"
                :key="i.crop_ru"
              >
                <p
                ...
                <p
                  ...
                  :style="`background-color: ${
                    i.percentage_change_cnt < 0 ? '#FE6A35' : '#109669'
                  }`"
                >
